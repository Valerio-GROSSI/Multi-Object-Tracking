...
```
p align="center">
Detection results obtained using the Ultralytics YOLO11 model on the MOT17 dataset.<br><br>
...
based on detections from the Ultralytics YOLO11 model (MOT17 dataset).<br><br>
